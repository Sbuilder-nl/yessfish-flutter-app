...
final List<Hoofdstuk> hoofdstukken = [
  ...
  Hoofdstuk(
    ...
    stappen: [
      ...
      Stap(id: 'vangst-nieuw', tab: _tabVangsten, zoek: 'vangst-nieuw',
        ...
        tekst: tx(
          'Met deze knop meld je een vangst: soort, gewicht, foto en het water. Straks na de rondleiding kun je het meteen proberen.',
          'This button logs a catch: species, weight, photo and the water. Try it right after the tour.',
          'Mit dieser Taste meldest du einen Fang: Art, Gewicht, Foto und Gewässer. Probier es gleich nach dem Rundgang.',
          'Ce bouton déclare une prise : espèce, poids, photo et l’eau. Essaie juste après la visite.',
          'Con este botón registras una captura: especie, peso, foto y el agua. Pruébalo justo después del recorrido.',
          'Tym przyciskiem zgłaszasz połów: gatunek, waga, zdjęcie i woda. Spróbuj zaraz po przewodniku.')),
      Stap(id: 'vangst-meerdere', tab: _tabVangsten, zoek: 'vangst-meerdere', optioneel: true,
        titel: tx('Meerdere vissen tegelijk', 'Several fish at once', 'Mehrere Fische auf einmal', 'Plusieurs poissons', 'Varios peces a la vez', 'Kilka ryb naraz'),
        tekst: tx(
          'Twintig voorns en twee brasems? Voeg soorten toe met een aantal erbij, in één melding. Vul bij het gewicht dat van de zwaarste vis in.',
          'Twenty roach and two bream? Add species with a number, in one report. For weight, enter the heaviest fish.',
          'Zwanzig Rotaugen und zwei Brassen? Füge Arten mit Anzahl hinzu, in einer Meldung. Beim Gewicht trägst du den schwersten Fisch ein.',
          'Vingt gardons et deux brèmes ? Ajoute des espèces avec un nombre, en une seule déclaration. Pour le poids, indique le plus lourd.',
          '¿Veinte rutilos y dos bremas? Añade especies con cantidad, en un solo registro. En peso, pon el más pesado.',
          'Dwadzieścia płoci i dwa leszcze? Dodaj gatunki z liczbą, w jednym zgłoszeniu. W wadze wpisz najcięższą rybę.')),
  ...
  Hoofdstuk(
    ...
    stappen: [
      ...
      Stap(id: 'kaart-dieptemenu', tab: _tabKaart, zoek: 'kaart-dieptemenu', optioneel: true,
