...
const Map<String, Map<String, String>> kDisciplineUi = {
  ...
  'later':    {'nl': 'Later', 'en': 'Later', 'de': 'Später', 'fr': 'Plus tard', 'es': 'Más tarde', 'pl': 'Później'},
  'prompt':   {'nl': 'Kies je visstijlen om je eigen dashboards te zien.', 'en': 'Choose your fishing styles to see your own dashboards.', 'de': 'Wähle deine Angelarten, um deine eigenen Dashboards zu sehen.', 'fr': 'Choisis tes styles de pêche pour voir tes tableaux de bord.', 'es': 'Elige tus estilos de pesca para ver tus paneles.', 'pl': 'Wybierz swoje style wędkarskie, aby zobaczyć własne panele.'},
};
