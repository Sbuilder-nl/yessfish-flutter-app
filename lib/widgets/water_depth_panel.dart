      ...
      Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [const Icon(Icons.water, size: 16, color: AppColors.navy), const SizedBox(width: 6),
            Expanded(child: Text(_t(_depthTitle), style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Colors.black54))),
            IconButton(visualDensity: VisualDensity.compact, padding: EdgeInsets.zero, iconSize: 17,
              icon: const Icon(Icons.info_outline, color: Colors.black38),
              onPressed: () => showDialog(context: context, builder: (ctx) => AlertDialog(
                scrollable: true,
                title: Text(_t(_helpTitle), style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
                content: Text(_t(_helpTxt), style: const TextStyle(fontSize: 13.5, height: 1.45)),
...
const _helpTitle = {'nl': 'Hoe werkt de dieptekaart?', 'en': 'How does the depth map work?', 'de': 'Wie funktioniert die Tiefenkarte?', 'fr': 'Comment marche la carte ?', 'es': '¿Cómo funciona el mapa?', 'pl': 'Jak działa mapa głębokości?'};
const _helpTxt = {
  'nl': 'De dieptekaart laat zien hoe diep het water overal is: licht = ondiep, donker = diep.\n\nDe gegevens komen van de officiële bodemmetingen van Rijkswaterstaat én van fishfinder-metingen van vissers zelf.\n\n🔓 Eenmalig ontgrendelen: 10 dobbers per water. Bijwerken met nieuwe metingen: 3 dobbers.\n🎣 Deel je zelf publiek je fishfinder-data op een water? Dan kijk je daar altijd gratis, ook naar updates.\n📍 Tik in de dieptekaart op het water voor de exacte diepte — je eigen stekken staan er ook op.\n🌊 Bij rivieren is de diepte een indicatie: het peil beweegt mee met de rivier.\n\nDobbers verdien je gratis door te posten, vangsten te delen en dieptedata te delen — of koop ze in de winkel.\n\n⚠️ Let op: deze kaart is bedoeld om mee te vissen en is niet geschikt voor navigatie op het water.',
  'en': 'The depth map shows how deep the water is: light = shallow, dark = deep.\n\nData comes from official Rijkswaterstaat bed surveys plus fishfinder readings shared by anglers.\n\n🔓 Unlock once: 10 bobbers per water. Updating with new readings: 3 bobbers.\n🎣 Share your own fishfinder data publicly on a water? Then you view it there for free, updates included.\n📍 Tap the water on the depth map for the exact depth — your own spots are shown too.\n🌊 On rivers the depth is indicative: the level moves with the river.\n\nEarn bobbers for free by posting, sharing catches and sharing depth data — or buy them in the shop.\n\n⚠️ Note: this map is meant for fishing and is not suitable for navigation.',
  'de': 'Die Tiefenkarte zeigt, wie tief das Wasser ist: hell = flach, dunkel = tief.\n\nDie Daten stammen aus offiziellen Rijkswaterstaat-Messungen und Echolot-Daten von Anglern.\n\n🔓 Einmal freischalten: 10 Posen pro Gewässer. Update mit neuen Messungen: 3 Posen.\n🎣 Teilst du deine Echolot-Daten öffentlich, schaust du dort immer gratis, Updates inklusive.\n📍 Tippe in der Karte aufs Wasser für die genaue Tiefe — deine Angelplätze werden angezeigt.\n🌊 Bei Flüssen ist die Tiefe ein Richtwert: der Pegel bewegt sich.\n\nPosen verdienst du gratis durch Posten und Teilen — oder kaufe sie im Shop.\n\n⚠️ Hinweis: Diese Karte ist zum Angeln gedacht und nicht für die Navigation geeignet.',
  'fr': 'La carte montre la profondeur partout : clair = peu profond, foncé = profond.\n\nDonnées : relevés officiels de Rijkswaterstaat + échosondeurs des pêcheurs.\n\n🔓 Débloquer une fois : 10 flotteurs par eau. Mise à jour : 3 flotteurs.\n🎣 Tu partages publiquement tes données ? Alors c’est gratuit, mises à jour comprises.\n📍 Touche l’eau pour la profondeur exacte — tes spots y figurent aussi.\n🌊 Sur les rivières la profondeur est indicative : le niveau varie.\n\nGagne des flotteurs en postant et partageant — ou achète-les en boutique.\n\n⚠️ Attention : cette carte sert à la pêche et ne convient pas à la navigation.',
  'es': 'El mapa muestra la profundidad: claro = poco profundo, oscuro = profundo.\n\nDatos: mediciones oficiales de Rijkswaterstaat + ecosondas de pescadores.\n\n🔓 Desbloquear una vez: 10 boyas por agua. Actualizar: 3 boyas.\n🎣 ¿Compartes tus datos públicamente? Entonces lo ves gratis, con actualizaciones.\n📍 Toca el agua para la profundidad exacta — tus sitios también aparecen.\n🌊 En ríos la profundidad es indicativa: el nivel varía.\n\nGana boyas publicando y compartiendo — o cómpralas en la tienda.\n\n⚠️ Atención: este mapa es para pescar y no sirve para la navegación.',
  'pl': 'Mapa pokazuje głębokość: jasny = płytko, ciemny = głęboko.\n\nDane: oficjalne pomiary Rijkswaterstaat + echosondy wędkarzy.\n\n🔓 Odblokowanie: 10 spławików na wodę. Aktualizacja: 3 spławiki.\n🎣 Udostępniasz publicznie swoje dane? Wtedy oglądasz za darmo, z aktualizacjami.\n📍 Dotknij wody, aby zobaczyć dokładną głębokość — twoje łowiska też są widoczne.\n🌊 Na rzekach głębokość jest orientacyjna: poziom się zmienia.\n\nSpławiki zdobywasz publikując i udostępniając — albo kup je w sklepie.\n\n⚠️ Uwaga: ta mapa służy do wędkowania i nie nadaje się do nawigacji.',
};
