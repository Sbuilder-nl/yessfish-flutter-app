...
class _FriendsScreenState extends State<FriendsScreen> {
  ...
  Future<void> _accept(int friendshipId) async { try { await Api.post('/friends/$friendshipId/accept'); } catch (e) { if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(e is ApiException ? e.message : context.tr('common.error')))); } _load(); }
