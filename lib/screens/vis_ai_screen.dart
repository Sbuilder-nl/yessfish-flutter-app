...
const Map<String, Map<String, String>> _kVisAi = {
  'nl': {
    ...
    'free': 'Gratis', 'left': 'gratis vragen vandaag', 'pts': 'dobbers',
    'earn': 'Verdien dobbers: post openbaar en koppel vangsten aan een water.',
  ...
  'en': {
    ...
    'free': 'Free', 'left': 'free questions today', 'pts': 'bobbers',
    'earn': 'Earn bobbers: post publicly and link catches to a water.',
  ...
  'de': {
    ...
    'free': 'Gratis', 'left': 'Gratisfragen heute', 'pts': 'Posen',
    'earn': 'Posen verdienen: öffentlich posten und Fänge mit einem Gewässer verknüpfen.',
  ...
  'fr': {
    ...
    'free': 'Gratuit', 'left': 'questions gratuites aujourd’hui', 'pts': 'flotteurs',
    'earn': 'Gagnez des flotteurs : publiez publiquement et liez vos prises à une eau.',
  ...
  'es': {
    ...
    'free': 'Gratis', 'left': 'preguntas gratis hoy', 'pts': 'boyas',
    'earn': 'Gana boyas: publica en público y vincula capturas a un agua.',
  ...
  'pl': {
    ...
    'free': 'Darmowe', 'left': 'darmowych pytań dziś', 'pts': 'spławiki',
    'earn': 'Zdobywaj spławiki: publikuj publicznie i wiąż połowy z wodą.',
